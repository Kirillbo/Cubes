...
public partial class GameEntity {
    ...
    public void AddPosition(UnityEngine.Vector2 newPosition, bool newChangePosition) {
        ...
        component.ChangePosition = newChangePosition;
        AddComponent(index, component);
    }

    public void ReplacePosition(UnityEngine.Vector2 newPosition, bool newChangePosition) {
        var index = GameComponentsLookup.Position;
        var component = (PositionComponent)CreateComponent(index, typeof(PositionComponent));
        component.Position = newPosition;
        component.ChangePosition = newChangePosition;
