...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, UnityEngine.Transform>(
            Move,
            game.GetGroup(GameMatcher.Move),
            (e, c) => ((MoveComponent)c).Transform));
    }
}

public static class ContextsExtensions {

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithMove(this GameContext context, UnityEngine.Transform Transform) {
        return ((Entitas.EntityIndex<GameEntity, UnityEngine.Transform>)context.GetEntityIndex(Contexts.Move)).GetEntities(Transform);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
